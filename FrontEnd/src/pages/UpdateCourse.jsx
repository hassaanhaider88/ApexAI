...
const UpdateCourse = () => {
  ...
  useEffect(() => {
    ...
    const singleCourse = DummyCoures.filter((course) => {
      return course._id === searchParams.get("id");
    });
    console.log(singleCourse);
    setFormData({
      cTitle: singleCourse[0].title,
      cCode: singleCourse[0].code,
      cDuration: singleCourse[0].duration,
      cFee: singleCourse[0].fee,
      cTiming: singleCourse[0].timing,
      cInstructor: singleCourse[0].instructor,
      cRegisteredUser: singleCourse[0].students,
      cRatings: singleCourse[0].rating,
      cOverView: singleCourse[0].overview,
      cModules: singleCourse[0].modules,
      cBenefits: singleCourse[0].benefits,
    });
    setCourseImg(singleCourse[0].image);
  }, []);
